//! HTTP transport executed in Rust (via reqwest) instead of the webview. This
//! sidesteps CORS, Chromium's private-network access blocking, and HTTP-plugin
//! URL-scope quirks: the desktop talks to the server exactly like any native
//! client. The JS API client calls these commands through a fetch shim.
...
pub struct HttpRequest {
    ...
    /// Optional text body (JSON requests).
    #[serde(default)]
